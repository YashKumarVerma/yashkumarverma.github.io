...
- [@hackcode/file-preview-page](https://www.npmjs.com/package/@hackcode/file-preview-page) : CLI to generate index page, listing all files and linking them to index.html recursively. Very handy when sharing files via cloud storages like surge.sh, firebase, netlify, vercel, etc.
